...
<div x-show="codModalOpen" x-cloak x-transition.opacity
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-full mx-4 md:max-w-lg md:mx-0 overflow-hidden"
        ...
        <form action="{{ route('transactions.store') }}" method="POST">
            ...
            {{-- FOOTER --}}
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/60 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-3">
                <button type="button" @click="codModalOpen = false"
                        class="w-full sm:w-auto px-5 py-2.5 rounded-xl border border-gray-200 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition">
                    Batal
                </button>
                <button type="submit"
                        class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-bold shadow-sm transition">
