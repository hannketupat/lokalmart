...
<div x-data="{ rating: 0, hoverRating: 0, comment: '' }"
    ...
    <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-full mx-4 md:max-w-md md:mx-0 overflow-hidden"
        ...
        <form action="{{ route('reviews.store', $transaction) }}" method="POST">
            ...
            <div class="px-6 py-4 border-t border-gray-100 bg-gray-50/60 flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-3">
                ...
                <button type="submit"
                        ...
                        class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl text-white text-sm font-bold transition">
