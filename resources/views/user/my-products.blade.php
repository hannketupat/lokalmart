...
@section('content')
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                <h1 class="text-xl md:text-2xl lg:text-3xl font-extrabold text-gray-900">Produk Saya</h1>
                <p class="mt-1.5 text-sm md:text-base text-gray-500">Kelola barang yang sedang kamu jual</p>
            </div>
        ...
        @php
            $statusLabel = [
                ...
                'pending' => ['Menunggu Review', 'bg-amber-100 text-amber-700'],
                        ...
                        <div class="flex-1 min-w-0 flex flex-col justify-between">
                            <div>
                                ...
                                @if($product->isRejected() && $product->rejection_reason)
                                    <div class="mt-2 rounded-xl bg-red-50 border border-red-200 px-3 py-2">
