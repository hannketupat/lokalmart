        ...
        <div class="relative px-6 py-10 sm:px-10 sm:py-12">
            <div class="flex flex-col sm:flex-row items-center sm:items-end gap-6">
                ...
                <div class="flex-1 text-center sm:text-left">
                    <h1 class="text-xl md:text-2xl lg:text-3xl font-bold text-white">{{ $user->name }}</h1>
                    ...
                    @endif
                    <div class="mt-4 flex flex-wrap items-center justify-center sm:justify-start gap-x-6 gap-y-2 text-sm">
                         ...
                         @foreach($activeProducts as $product)
                             <article class="group bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-shadow">
                                 <a href="{{ route('products.show', $product->slug) }}" class="block">
                                     ...
                                     <div class="p-4">
                                         <h3 class="font-medium text-gray-900 line-clamp-1 group-hover:text-indigo-600 transition">{{ $product->name }}</h3>
